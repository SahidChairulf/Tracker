<template>
  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="bg-[#9EB384] menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow text-black rounded-box w-52">
        <li><a>Homepage</a></li>
        <li><a>Portfolio</a></li>
        <li><a>About</a></li>
      </ul>
  ...
  <div class="navbar-center text-[#FAF1E4]">
    <a class="logo btn btn-ghost normal-case text-xl">MangRovin</a>
  </div>
