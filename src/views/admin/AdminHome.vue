...
<template>
    ...
    <div x-data="setup()" x-init="$refs.loading.classList.add('hidden')" :class="{ 'dark': isDark }"
        ...
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
            ...
            <!-- Backdrop -->
            <div x-show="isSidebarOpen" @click="isSidebarOpen = false" class="fixed inset-0 z-10 bg-indigo-800 md:hidden"
            ...
            <div class="flex flex-1 h-screen overflow-y-scroll">
                ...
                <section x-show="isUserPanelOpen" x-transition:enter="transition duration-300 ease-in-out transform"
                    ...
                    @keydown.escape="window.innerWidth <= 1024 ? isUserPanelOpen = false : ''" tabindex="-1"
                    x-ref="userPanel"
                    ...
                    <div class="flex flex-col h-screen">
                        ...
                        <div class="flex-1 p-4 space-y-8 overflow-y-hidden hover:overflow-y-auto">
                            ...
                            <div class="flex flex-col items-center space-y-2">
                                <!-- User avatar -->
                                <img class="w-20 h-20 rounded-full dark:opacity-70"
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-4">
                                    <a href="#" class="flex items-start space-x-2 group">
                                        <img class="flex-shrink-0 object-cover w-12 h-12 rounded-full"
                        ...
                        <!-- Panel footer -->
                        <footer
                            class="flex items-center justify-between flex-shrink-0 px-4 py-2 border-t dark:border-indigo-800">
                            <div class="text-sm">
                                View on
                                <a href="https://github.com/Kamona-WD/kwd-dashboard" target="_blank"
